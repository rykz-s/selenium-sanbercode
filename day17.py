...
class TestLogin(unittest.TestCase): 
    ...
    def test_a_success_signup(self): 
        ...
        browser.find_element(By.XPATH,"/html/body/div/div[1]/form/input[1]").send_keys("Ryu") # isi nama by Full XPATH
        time.sleep(1)
        browser.find_element(By.XPATH,"//*[@id='email_register']").send_keys("testselenium@gmail.com") # isi email by XPATH
        time.sleep(1)
        browser.find_element(By.ID,"password_register").send_keys("Testing1234") # klik tombol sign in
        time.sleep(1)
